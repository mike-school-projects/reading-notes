...
// console.log(containsW('hello everyone'));
...
// console.log(containsWorld('hello world'));
// console.log(containsWorld('Hello World'));
// console.log(containsWorld('hello everyone'));
...
const citiesAtoJ = (arr) => {
  ...
  if (regex.test(tempString)) {
    tempArray = tempString.match(regex);
  }
...
const matchMonth = (input) => {
  let regex1 = /\b(October)\b/;
  let regex2 = /\b(Oct)\b/;
  let regex3 = /\b(october)\b/;
  let regex4 = /\b(oct)\b/;
...
// console.log(noPunctuation(lorem))
...
// let startString = 'I wAnt them all tO bE removed and replaced with Underscores.';
// console.log(hangman(startString));

...
// console.log(updateAnimal(['Dog', 'Cat'], lower));
...
// console.log(sortNames(['dog', 'cat', 'horse', 'Elks']));
...
// console.log(sortNumbers([2, 6, 4, 1, 8, 5]));
...
// console.log(sortBackwards([2, 6, 4, 1, 8, 5]));
...
// console.log(alphabetizeBetter(['Alphabet', 'Zebra', 'alphabet', 'carrot']));
...
// console.log(sortByLength(['Alphabets', 'Zebra', 'alphabet', 'carrot']));
...
// console.log(sortNumbersByLength([1, 14, 0.2, -281, 54782]));
...
const people = [
  ...
  new Person('Bill', 'Washington', 38),
  new Person('Stan', 'Seattle', 67),
  new Person('Bill', 'Washington', 25),
...
// **** Test sequence is wrong.  It doesn't include either bill ****
...
// console.log(sortPeopleBetter(people));
...
const sortMeetingsByDay = (arr) => {
  // Add property dayOfWeek corresponding to the numberic value of the day of week
  arr.forEach((element) => {
    if (element.dayOfWeek.toLowerCase() === 'sunday') {
      element.dayOfWeekNum = 0;
    } else if (element.dayOfWeek.toLowerCase() === 'monday') {
      element.dayOfWeekNum = 1;
    } else if (element.dayOfWeek.toLowerCase() === 'tuesday') {
      element.dayOfWeekNum = 2;
    } else if (element.dayOfWeek.toLowerCase() === 'wednesday') {
      element.dayOfWeekNum = 3;
    } else if (element.dayOfWeek.toLowerCase() === 'thursday') {
      element.dayOfWeekNum = 4;
    } else if (element.dayOfWeek.toLowerCase() === 'friday') {
      element.dayOfWeekNum = 5;
    } else if (element.dayOfWeek.toLowerCase() === 'saturday') {
      element.dayOfWeekNum = 6;
    }
  });

  // sort by dayOfWeek
  arr.sort((a, b) => {
    if (a.dayOfWeekNum > b.dayOfWeekNum) {
      return 1;
    } else return -1;
  });

  // delete dayOfWeek
  arr.forEach((element) => delete element.dayOfWeekNum);
  return arr;
};
...
const sortSchedule = (arr) => {
  ...
  // sort by dayOfWeek, then start, then end
  arr.sort((a, b) => {
    if (a.dayOfWeekNum > b.dayOfWeekNum) {
      return 1;
    } else if (a.dayOfWeekNum < b.dayOfWeekNum) {
      return -1;
